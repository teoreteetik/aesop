...
public enum ComponentType {
    ...
    LIS2A2ToMyLabConverter(LIS2A2ToMyLabConverter.class, DestinationConf::create),
    MyLabToLIS2A2Converter(MyLabToLIS2A2Converter.class, DestinationConf::create),
    LIS2A2ToStringConverter(LIS2A2ToStringConverter.class, DestinationConf::create),
    StringToLIS2A2Converter(StringToLIS2A2Converter.class, DestinationConf::create),
